 ...
 * @returns
 */
function toDistribGroupUser(url,sectionId,groupName,callbackUrl){
	$.Mark.show();
	$.ajax({
		type : 'POST',
		url : ctx + url,
		data:{"groupId":sectionId,"groupName":groupName,"callbackUrl":callbackUrl},
		cache : false,
		success : function(response) {
			$.Mark.hide();
			$("#content").css("display", "block");
 ...
 * @returns
 */
function toNotGroupUser(url,sectionId,groupName,callbackUrl){
	$.Mark.show();
	$.ajax({
		type : 'POST',
		url : ctx + url,
		data:{"groupId":sectionId,"disflag":"1","groupName":groupName,"callbackUrl":callbackUrl},
		cache : false,
		success : function(response) {
			$.Mark.hide();
			$("#content").css("display", "block");
