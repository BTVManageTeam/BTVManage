...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '" style="top:40%"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">取消</a> <a href="#" class="btn btn-danger" data-action="1">确定</a></div></div>').appendTo(this.options.appendTo).hide();
