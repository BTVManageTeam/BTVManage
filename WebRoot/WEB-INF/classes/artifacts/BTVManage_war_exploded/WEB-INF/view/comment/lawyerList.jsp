...
<div class="widget-box">
	<div class="widget-title">
		<span class="icon"><a href="javascript:;" id="serviceSituation" shref="<%=request.getContextPath()%>/api/xy/wechatMessage/v1/queryWechatMessage4page/"  onclick="openurl(this)"><img src="../../../images/backBtn.svg" alt="img"></a></span>
	</div>
