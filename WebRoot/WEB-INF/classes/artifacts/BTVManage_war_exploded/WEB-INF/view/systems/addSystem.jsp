...
<div class="widget-box112">
	...
	<%--
		开始添加的内容
		--%>
		<form id="addSystemFrom" class="form-horizontal">
			<div id="gridPager">
				<table style="width: 100%; padding: 8px; ">
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="systemHoverLogoUrl" id="systemHoverLogoUrl" value=""/>
					...
					<tr>
						...
						<td width="30%">
							<input type="text" name="systemAppCode" id="systemAppCode"
								value="" datatype="s1-20" errormsg="系统编号为1-20个字符(下划线、空格、数字、字母和汉字)"
								nullmsg="请输入系统编号" />
						...
						<td width="30%">
						<input type="text" name="enterpriseName" id="enterpriseName" value="" 
					...
					<tr>
						...
						<td width="30%">
							<input type="text" name="systemName" id="systemName"
								value="" datatype="s1-20" errormsg="系统名为1-20个字符(下划线、空格、数字、字母和汉字)"
								nullmsg="请输入系统名称" />
							<span style="color: red; font-size: 16px;">*</span>
							<div class="Validform_checktip"></div>
						</td>
						...
						<td width="30%">
						<input type="text" name="systemMark" id="systemMark" value="" 
					...
					<tr>
						...
						<td>
							<input type="text" name="systemUrl" id="systemUrl"  datatype="url" value=""  nullmsg="请输入系统url"/>
							<span style="color: red; font-size: 16px;">*</span>
							<div class="Validform_checktip"></div>
						</td>
						<td align="right">
					...
					<tr>
						...
						<td colspan="3">
							<textarea style="width: 78%; height: 80px;" name="showUrl" id="showUrl" ></textarea>
							<div class="Validform_checktip"></div>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<textarea style="width: 78%; height: 80px;" name="systemDesc" id="userDesc"  datatype="*1-200" ignore="ignore" errormsg="系统描述最多200字符"></textarea>
							<div class="Validform_checktip"></div>
						</td>
					</tr>	
					<tr>
