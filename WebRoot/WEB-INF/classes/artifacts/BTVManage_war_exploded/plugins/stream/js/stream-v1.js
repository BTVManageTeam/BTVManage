...
(function(){
	var Provider, nIdCount = 0, aOtherBrowsers = ["Maxthon", "SE 2.X", "QQBrowser"],
		...
		sCellFileTemplate = '<b class="stream-uploading-ico"></b>' +
					...
					'	<a class="stream-cancel" href="javascript:void(0)" onclick="del_alert()"></a>' +
					'	<span class="stream-process-bar"><span style="width: 0%;"></span></span>' +
					'	<p class="stream-percent_p">\u5df2\u4e0a\u4f20 <span class="stream-percent">0%</span></p>' +
					'</div>' +
		...
		sTotalContainer = '<div id="#totalContainerId#" class="stream-total-tips">' +
			'	<span class="stream-process-bar"><span style="width: 0%;"></span></span>' +
			'	<p class="stream-percent_p">\u5df2\u4e0a\u4f20 <span class="stream-percent">0%</span></p><strong class="_stream-total-uploaded">&nbsp;</strong>' +
			
			'	<strong class="_stream-total-size">&nbsp;</strong>' +
			'</div>',
